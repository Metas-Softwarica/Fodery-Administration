...
class _RestaurantListingScreenState extends State<RestaurantListingScreen> {
  ...
  final _restaurantList = [
    {'restraurantName': 'The Eatery', 'status': 'open'},
    {'restraurantName': 'Salmons', 'status': 'open'},
    {'restraurantName': 'Eatery', 'status': 'close'},
    {'restraurantName': 'Restau', 'status': 'close'},
    {'restraurantName': 'KFC', 'status': 'open'},
  ];

  // RESTARURANT CARD
  Widget restCard = Padding(
